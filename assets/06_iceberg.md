...
A PySpark job is provided to perform the following steps:
...
Navigate to Dataproc > Batches and you will see the submitted job executing. Once the job finishes (around 2-3 min.):
